														...
														<tr>
															<td class="pad" style="padding-top:15px;">
																<div style="color:#ffffff;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:40px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:48px;">
																	<p style="margin: 0;">${user} has voted for session</p>
																</div>
															</td>
														</tr>
													</table>
...
module.exports = emailVoteResponce;
